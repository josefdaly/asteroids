(function () {
  ...
  Game.prototype.wrap = function (pos) {
    if (pos[0] < -15) {
      pos[0] = window.innerWidth + pos[0] + 15;
    } else if (pos[0] > window.innerWidth + 15) {
      pos[0] = pos[0] % window.innerWidth - 15;
    } else if (pos[1] < -15) {
      pos[1] = window.innerHeight + pos[1] + 15;
    } else if (pos[1] > window.innerHeight + 15) {
      pos[1] = pos[1] % window.innerHeight - 15;
    }
